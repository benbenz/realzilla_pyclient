...
class GeoGetCountryByCodeResponse200(BaseModel):
    """
    GeoGetCountryByCodeResponse200
    """ # noqa: E501
    success: StrictBool
    data: GeoGetCountryByCodeResponse200Data
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": GeoGetCountryByCodeResponse200Data.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
