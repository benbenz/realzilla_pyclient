...
class AdminSearchGetSearchQueriesResponse200(BaseModel):
    """
    AdminSearchGetSearchQueriesResponse200
    """ # noqa: E501
    success: StrictBool
    data: AdminSearchGetSearchQueriesResponse200Data
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": AdminSearchGetSearchQueriesResponse200Data.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
