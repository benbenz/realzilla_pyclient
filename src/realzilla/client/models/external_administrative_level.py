...
class ExternalAdministrativeLevel(BaseModel):
    """
    ...
    code: StrictStr
    parent: Optional[ExternalAdministrativeLevel] = None
    __properties: ClassVar[List[str]] = ["id", "name", "nameNormalized", "level", "code", "parent"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "level": obj.get("level"),
            "code": obj.get("code"),
            "parent": ExternalAdministrativeLevel.from_dict(obj["parent"]) if obj.get("parent") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
ExternalAdministrativeLevel.model_rebuild(raise_errors=False)
