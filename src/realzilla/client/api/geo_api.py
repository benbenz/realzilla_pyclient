...
class GeoApi:
    ...
    @validate_call
    def geo_countries_country_code_get(
        self,
        ...
        _param = self._geo_countries_country_code_get_serialize(
    ...
    @validate_call
    def geo_countries_country_code_get_with_http_info(
        self,
        country_code: CountryCode,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GeoCountriesCountryCodeGet200Response]:
        """geo_countries_country_code_get
    ...
    @validate_call
    def geo_countries_country_code_get_without_preload_content(
        self,
        country_code: CountryCode,
        _request_timeout: Union[
            None,
    ...
    def _geo_countries_country_code_get_serialize(
        self,
        country_code,
        _request_auth,
        _content_type,
        ...
        if country_code is not None:
            _path_params['countryCode'] = country_code.value
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/geo/countries/{countryCode}',
